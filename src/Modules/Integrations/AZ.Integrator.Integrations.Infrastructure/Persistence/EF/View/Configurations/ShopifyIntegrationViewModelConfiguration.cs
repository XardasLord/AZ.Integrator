...
public class ShopifyIntegrationViewModelConfiguration : IEntityTypeConfiguration<ShopifyIntegrationViewModel>
{
    public void Configure(EntityTypeBuilder<ShopifyIntegrationViewModel> builder)
    {
        builder.ToView("shopify_view", SchemaDefinition.Integration);
        ...
        builder.Property(e => e.AdminApiToken).HasColumnName("admin_api_token");
