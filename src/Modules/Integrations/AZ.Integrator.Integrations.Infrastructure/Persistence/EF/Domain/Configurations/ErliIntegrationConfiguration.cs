...
public class ErliIntegrationConfiguration : IEntityTypeConfiguration<ErliIntegration>
{
    public void Configure(EntityTypeBuilder<ErliIntegration> builder)
    {
        builder.ToTable("erli", SchemaDefinition.Integration);
