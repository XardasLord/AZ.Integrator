...
public record CreateFurniturePartLineRequest(
    ...
    OrderFurniturePartLineDimensionsEdgeBandingTypeViewModel LengthEdgeBandingType,
    OrderFurniturePartLineDimensionsEdgeBandingTypeViewModel WidthEdgeBandingType
);
